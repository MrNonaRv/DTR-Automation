...
const oldParseDateTimeString = `  const parseDateTimeString = (s: string) => {
...
const newParseDateTimeString = `  const parseDateTimeString = (s: string) => {
