...
echo ===================================================
echo Creating Desktop Shortcut for Mambusao DTR Automate
echo ===================================================
...
echo sLinkFile = "%USERPROFILE%\Desktop\Mambusao DTR Automate.lnk" >> %VBS_SCRIPT%
echo Set oLink = oWS.CreateShortcut(sLinkFile) >> %VBS_SCRIPT%
echo oLink.TargetPath = "%~dp0start-windows.bat" >> %VBS_SCRIPT%
echo oLink.WorkingDirectory = "%~dp0" >> %VBS_SCRIPT%
echo oLink.Description = "Mambusao DTR Automate Local Server" >> %VBS_SCRIPT%
...
echo You can now close this window and double-click the "Mambusao DTR Automate" icon on your Desktop to start the system.
echo.
pause
